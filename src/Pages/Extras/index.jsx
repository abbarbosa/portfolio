...
function Extras() {
    ...
    return (
        <div className="h-[1500px] w-screen bg-[#2D2D2D] flex flex-col">
            <Header />
            ...
            <div className="flex items-start pl-10 pt-10">
                <h1 className="text-complementary-white text-[36px]">Ensaios fotográficos</h1>
            </div>
            <hr className="w-[80%]" />
            ...
            <div className="flex items-start pl-10">
                <h1 className="text-complementary-white text-[36px]" >Animações</h1>
            </div>
            <hr className="w-[80%]" />
            ...
            <div className="flex items-start pl-10">
                <h1 className="text-complementary-white text-[36px]" >Vídeos Institucionais</h1>
            </div>
            <hr className="w-[80%]" />
